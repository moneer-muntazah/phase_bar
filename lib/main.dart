      ...
      body: Center(
        child: StagesBar(
          ...
          phases: <Phase>[
            ...
            // Phase(text: "ملغى"),
            Phase(text: "In progress", status: PhaseStatus.Done),
            Phase(text: "Being prepared", status: PhaseStatus.Done),
            Phase(text: "Out for delivery", status: PhaseStatus.Done),
            Phase(text: "Done", status: PhaseStatus.InProgress),
            Phase(text: "Cancel"),
          ],
        ),
      ),
